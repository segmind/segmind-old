...
from segmind_track.utils.validation import _validate_db_type_string

_INVALID_DB_URI_MSG = 'Please refer to https://segmind_track.org/docs/latest/tracking.html#storage for ' \
