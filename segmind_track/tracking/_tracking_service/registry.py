from segmind_track.tracking.registry import StoreRegistry
...
class TrackingStoreRegistry(StoreRegistry):
    ...
    `segmind_track.tracking_store` group can be automatically registered through the
    ...
    def get_store(self, store_uri=None, artifact_uri=None):
        ...
        :return: An instance of `segmind_track.store.tracking.AbstractStore` that fulfills the store URI
                 requirements.
        """
        from segmind_track.tracking._tracking_service import utils
