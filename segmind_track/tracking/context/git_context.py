...
from segmind_track.tracking.context.default_context import _get_main_file
from segmind_track.utils.mlflow_tags import MLFLOW_GIT_COMMIT
...
def _get_git_commit(path):
    ...
    try:
        ...
        return commit
    except (git.InvalidGitRepositoryError, git.GitCommandNotFound, ValueError,
            git.NoSuchPathError):
        return None
