...
from segmind_track.protos.errorcodes_pb2 import FEATURE_DISABLED
from segmind_track.protos.service_lite_pb2 import Artifact, LogMetric, LogParam
from segmind_track.store.tracking import SEARCH_MAX_RESULTS_DEFAULT
from segmind_track.store.tracking.rest_store import RestStore
#from segmind_track.tracking._model_registry.client import ModelRegistryClient
from segmind_track.tracking.registry import \
...
class MlflowClient(object):
    ...
    def __init__(self, tracking_uri=None, registry_uri=None):
        ...
        :param tracking_uri: Address of local or remote tracking server. If not provided, defaults
                             to the service set by ``segmind_track.tracking.set_tracking_uri``. See
                             `Where Runs Get Recorded <../tracking.html#where-runs-get-recorded>`_
                             for more info.
        :param registry_uri: Address of local or remote model registry server. If not provided,
                             defaults to the service set by ``segmind_track.tracking.set_tracking_uri``.
        """
    ...
    def _get_registry_client(self):
        """Attempts to create a py:class:`ModelRegistryClient` if one does not
        already exist.

        :raises: py:class:`segmind_track.exceptions.MlflowException` if the py:class:`ModelRegistryClient`
            ...
            try:
                ...
                raise MlflowException(
                    ...
                    ' {schemes}.'.format(
                        ...
                        schemes=exc.supported_uri_schemes), FEATURE_DISABLED)
    ...
    def get_run(self, run_id):
        """
        Fetch the run from backend store. The resulting :py:class:`Run <segmind_track.entities.Run>`
    ...
    def create_run(self, experiment_id, start_time=None, tags=None):
        """
        Create a :py:class:`segmind_track.entities.Run` object that can be associated with
        metrics, parameters, artifacts, etc.
        Unlike :py:func:`segmind_track.projects.run`, creates objects but does not run code.
        Unlike :py:func:`segmind_track.start_run`, does not change the "active run" used by
        :py:func:`segmind_track.log_param`.
    ...
    def set_terminated(self, run_id, status=None, end_time=None):
        ...
        :param status: A string value of :py:class:`segmind_track.entities.RunStatus`.
    ...
    def search_runs(self,
        ...
        :param run_view_type: one of enum values ACTIVE_ONLY, DELETED_ONLY, or ALL runs
                              defined in :py:class:`segmind_track.entities.ViewType`.
    ...
    def create_registered_model(self, name):
        ...
        :return: A single object of :py:class:`segmind_track.entities.model_registry.RegisteredModel`
                 created by backend.
        """
    ...
    def update_registered_model(self, name, new_name=None, description=None):
        ...
        :return: A single updated :py:class:`segmind_track.entities.model_registry.RegisteredModel` object.
        """
    ...
    def list_registered_models(self):
        ...
        :return: List of :py:class:`segmind_track.entities.model_registry.RegisteredModel` objects.
        """
    ...
    def get_registered_model_details(self, name):
        """
        :param name: Name of the registered model to update.
        :return: A single :py:class:`segmind_track.entities.model_registry.RegisteredModelDetailed` object.
        """
    ...
    def get_latest_versions(self, name, stages=None):
        ...
        :param stages: List of desired stages. If input list is None, return latest versions for
                       for ALL_STAGES.
        :return: List of `:py:class:`segmind_track.entities.model_registry.ModelVersionDetailed` objects.
        """
    ...
    def create_model_version(self, name, source, run_id):
        ...
        :return: Single :py:class:`segmind_track.entities.model_registry.ModelVersion` object created by
                 backend.
        """
    ...
    def get_model_version_details(self, name, version):
        ...
        :param name: Name of the containing registered model.
        :param version: Version number of the model version.
        :return: A single :py:class:`segmind_track.entities.model_registry.ModelVersionDetailed` object.
        """
    ...
    def search_model_versions(self, filter_string):
        ...
        :param filter_string: A filter string expression. Currently supports a single filter
                              ...
                              ``run_id = '...'``.
        :return: PagedList of :py:class:`segmind_track.entities.model_registry.ModelVersion` objects.
        """
