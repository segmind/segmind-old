...
from segmind_track.protos.errorcodes_pb2 import (
    BAD_REQUEST, ENDPOINT_NOT_FOUND, INTERNAL_ERROR, INVALID_PARAMETER_VALUE,
    INVALID_STATE, PERMISSION_DENIED, REQUEST_LIMIT_EXCEEDED,
    RESOURCE_ALREADY_EXISTS, RESOURCE_DOES_NOT_EXIST, TEMPORARILY_UNAVAILABLE,
    ErrorCode)
