...
from segmind_track import data
from segmind_track.exceptions import ExecutionException
from segmind_track.utils.file_utils import get_local_path_or_none
    ...
    def compute_parameters(self, user_parameters, storage_dir):
        ...
        for key, param_obj in self.parameters.items():
            value = user_parameters[
                key] if key in user_parameters else self.parameters[key].default
