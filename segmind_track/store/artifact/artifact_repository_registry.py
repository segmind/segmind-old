...
from segmind_track.store.artifact.azure_blob_artifact_repo import \
    AzureBlobArtifactRepository
from segmind_track.store.artifact.dbfs_artifact_repo import \
    dbfs_artifact_repo_factory
from segmind_track.store.artifact.ftp_artifact_repo import \
    FTPArtifactRepository
from segmind_track.store.artifact.gcs_artifact_repo import \
    GCSArtifactRepository
from segmind_track.store.artifact.hdfs_artifact_repo import \
    HdfsArtifactRepository
from segmind_track.store.artifact.local_artifact_repo import \
    LocalArtifactRepository
from segmind_track.store.artifact.models_artifact_repo import \
    ModelsArtifactRepository
from segmind_track.store.artifact.runs_artifact_repo import \
    RunsArtifactRepository
from segmind_track.store.artifact.s3_artifact_repo import S3ArtifactRepository
from segmind_track.store.artifact.sftp_artifact_repo import \
    SFTPArtifactRepository
from segmind_track.utils.uri import get_uri_scheme
...
class ArtifactRepositoryRegistry:
    ...
    the entrypoints `segmind_track.artifact_repository` group can be automatically registered through the
    ...
    def register_entrypoints(self):
        ...
        for entrypoint in entrypoints.get_group_all(
            ...
            try:
                ...
                warnings.warn(
                    'Failure attempting to register artifact repository for scheme "{}": {}'
    ...
    def get_artifact_repository(self, artifact_uri):
        ...
        :return: An instance of `segmind_track.store.ArtifactRepository` that fulfills the artifact URI
                 requirements.
        """
