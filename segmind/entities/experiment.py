...
from segmind.protos.service_lite_pb2 import Experiment as ProtoExperiment
from segmind.protos.service_lite_pb2 import ExperimentTag as ProtoExperimentTag
...
class Experiment(_MLflowObject):
    ...
    def from_proto(cls, proto):
        experiment = cls(proto.experiment_id, proto.name,
                         proto.artifact_location, proto.lifecycle_stage)
    ...
    def to_proto(self):
        ...
        experiment.tags.extend([
            ProtoExperimentTag(key=key, value=val)
